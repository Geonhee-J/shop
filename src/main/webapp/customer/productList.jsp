...
<%@ include file="/customer/action/productListAction.jsp"%>
        ...
        <div class="productlist-wrap">
            ...
            <div class="productlist-category">
                <div class="productlist-category-btn">
                    <a href="/shop/customer/productList.jsp">전체</a>
                    <%
                        for (HashMap map : categoryList) {
                            %>
                                <a href="/shop/customer/productList.jsp?category=<%=(String)(map.get("category"))%>">
                ...
                <div class="productlist-category-btn">
                    <form class="productlist-form" method="get" action="/shop/customer/productList.jsp">
                ...
                <div class="productlist-sort-container">
                    <ul class="productlist-sort-wrap">
                        <li class="productlist-sort">
                            <a href="/shop/customer/productList.jsp?sort=category">
                                카테고리순
                            </a>
                        </li>
                        <li class="productlist-sort">
                            <a href="/shop/customer/productList.jsp?sort=min">
                                낮은가격순
                            </a>
                        </li>
                        <li class="productlist-sort">
                            <a href="/shop/customer/productList.jsp?sort=max">
                                높은가격순
                            </a>
                        </li>
                        <li class="productlist-sort">
                            <a href="/shop/customer/productList.jsp?sort=new">
                                신상품순
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="productlist-paging-container">
                    <%
                        if (currentPage > 1) {
                            %>
                                <div class="productlist-paging-btn">
                                    <a href="/shop/customer/productList.jsp?category=<%=category%>&sort=<%=sort%>">처음페이지</a>
                                    <a href="/shop/customer/productList.jsp?currentPage=<%=currentPage - 1%>&category=<%=category%>&sort=<%=sort%>">이전페이지</a>
                                </div>
                            <%
                        }
                        if (currentPage < lastPage) {
                            %>
                                <div class="productlist-paging-btn">
                                    <a href="/shop/customer/productList.jsp?currentPage=<%=currentPage + 1%>&category=<%=category%>&sort=<%=sort%>">다음페이지</a>
                                    <a href="/shop/customer/productList.jsp?currentPage=<%=lastPage%>&category=<%=category%>&sort=<%=sort%>">마지막페이지</a>
                                </div>
                            <%
                        }
                    %>
                    ...
                    <ul class="productlist-item-wrap">
                        <%
                            for (HashMap map : product) {
                                %>
                                    <a href="/shop/customer/productOne.jsp?productNo=<%=(Integer)(map.get("productNo"))%>">
